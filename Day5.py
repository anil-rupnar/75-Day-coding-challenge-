"""
Problem statement :
    write a program to find all pssible prime numbers within the range.
    Input : two +ve integers separated by space denting start and end of range.
    Output : list of all pssible prime numbers within the range separated by range.
    """
def is_prime(num):
    if num < 2:
        return False
